    ...
    <div>
        ...
        <div>
            <table>
                <thead>
                    <tr class="theadtr">
                        ...
                        <th class="theadth" scope="col">Email</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
          ...
          <td class='tbodytd'>" . $row['email'] . "</td>
            ...
            <br>
            <form action="show_ta.php" method="POST">
